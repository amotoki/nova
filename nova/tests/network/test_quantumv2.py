...
class TestQuantumv2(test.TestCase):
    ...
    def test_get_floating_ip_by_address_not_found(self):
        ...
        self.mox.ReplayAll()
        with self.assertRaises(exception.FloatingIpNotFoundForAddress):
            api.get_floating_ip_by_address(self.context, address)
    ...
    def test_get_floating_ip_by_address_multiple_found(self):
        ...
        self.mox.ReplayAll()
        with self.assertRaises(exception.FloatingIpMultipleFoundForAddress):
            api.get_floating_ip_by_address(self.context, address)
    ...
    def test_release_floating_ip_associated(self):
        ...
        self.mox.ReplayAll()
        with self.assertRaises(exception.FloatingIpAssociated):
            api.release_floating_ip(self.context, address)
    ...
    def test_associate_floating_ip_not_found_fixed_ip(self):
        ...
        self.mox.ReplayAll()
        with self.assertRaises(exception.FixedIpNotFoundForAddress):
            api.associate_floating_ip(self.context, self.instance,
                                      address, fixed_address)
